...
/*!
    ...
    to the universally unique identifier corresponding
    to the newly created team.
    \param team_name a character pointer corresponding
    to the name of the newly created team.
    \param user_id a character pointer corresponding
    to the name of the user who created the team.
...
/*!
    \param team_id a character pointer corresponding
    to the universally unique identifier corresponding
    to the team hosting the channel.
    ...
    to the name of the newly created channel.
    \return On success, 1 is returned. On error,
    -1 is returned and errno is set appropriately
*/
...
/*!
    \param thread_id a character pointer corresponding
    to the universally unique identifier corresponding
    to the thread hosting the message.
    \param user_id a character pointer corresponding
    to the universally unique identifier corresponding
    to of the user posting the message.
    \param message a character pointer corresponding
...
/*!
    ...
    \param user_id a character pointer corresponding
    to the universally unique identifier corresponding
    to of the user joining the team.
    \return On success, 1 is returned. On error,
    -1 is returned and errno is set appropriately
*/
...
/*!
    ...
    to the name of the newly created user.
    \return On success, 1 is returned. On error,
    -1 is returned and errno is set appropriately
*/
...
/*!
    ...
    the universally unique identifier corresponding
    to the newly logged user.
    \return On success, 1 is returned. On error,
    -1 is returned and errno is set appropriately
*/
...
/*!
    \param sender_id a character pointer corresponding to
    the universally unique identifier corresponding to
    the user sending the message.
    \param receiver_id a character pointer corresponding
    to the universally unique identifier corresponding to
